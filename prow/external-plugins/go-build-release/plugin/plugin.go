...
const (
	...
	PluginName         = "go-build-release"
	needsRebaseMessage = "Build and release."
)
...
func HelpProvider(enabledRepos []string) (*pluginhelp.PluginHelp, error) {
	return &pluginhelp.PluginHelp{
			Description: `The needs-rebase plugin manages the '` + PluginName + `' label by removing it from Pull Requests that are mergeable and adding it to those which are not.
